...
<html>
	<style>
	  body
  {
    background-image: url( "Images/ASUS_Republic_of_Gamers-175332.jpg");
...
<ul>
  ...
  <tr>
    ...
    <td height="198" colspan="2" align="center" >
      ...
      <tbody>
        <tr>
          <td width="367" height="219" align="center"><img src="Images/20200328_Asus_Zephyrus_duo15.jpg" width="216" height="211"alt=""/></td>
        </tr>
      </tbody>
    </table>
      <table width="262" height="42" border="0">
        <tbody>
          <tr>
            <td><h1 align="center" style="color: #FFFFFF; font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif;"> ASUS
</h1></td>
          </tr>
        </tbody>
      </table>
        ...
        <td width="521">
            <table width="512">
              ...
              <tr>
                ...
                <td width='46'><a href='Updatestoreasus.php?id=".$row["id"]."'><img src='Images/edit2.png' alt='' width='32' height='34' />Edit</a></td>
                <td width='45'><a href='DeleteStoreasus.php?id=".$row["id"]."'><img src='Images/delete.jpg' alt='' width='32' height='34' />Delete </a></td>
