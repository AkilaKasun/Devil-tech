...
<ul>
  ...
  <tr>
    ...
    <td height="198" colspan="2" align="center">
      ...
      <tbody>
        <tr>
          <td align="center"><img src="Images/dell-g15-gaming-laptop.jpg" width="216" height="211" alt=""/></td>
        </tr>
      </tbody>
    </table>
        ...
        <td width="521">
            <table width="512">
              ...
              <tr>
                ...
                <td width='46'><a href='Updatestoredell.php?id=".$row["id"]."'><img src='Images/edit2.png' alt='' width='32' height='34' />Edit</a></td>
                <td width='45'><a href='DeleteStoredell.php?id=".$row["id"]."'><img src='Images/delete.jpg' alt='' width='32' height='34' />Delete </a></td>
