...
<html>
	<style>
	  body
  {
    background-image: url( "Images/bertan-baday-logo-47.jpg");
...
<ul>
  ...
  <tr>
    ...
    <td height="198" colspan="2" align="center" ><p>&nbsp;</p>
      ...
      <tbody>
        <tr>
          <td width="367" height="219" align="center"><img src="Images/msi-summer-promo-laptop-1.png" width="216" height="211" alt=""/></td>
        </tr>
      </tbody>
    </table>
      <table width="262" height="42" border="0">
        <tbody>
          <tr>
            <td><h1 align="center" style="color: #FEFFFE; font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif;">MSI</h1></td>
          </tr>
        </tbody>
      </table>
