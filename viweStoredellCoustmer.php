...
<html>
	  ...
	  body
  {
    background-image: url( "Images/33804.jpg");
  ...
  <tr>
    ...
    <td height="198" colspan="2" align="center" >
      ...
      <table width="262" height="42" border="0">
        <tbody>
          <tr>
            <td><h1 align="center" style="color: #FFFFFF; font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif;"> DELL
</h1></td>
          </tr>
        </tbody>
      </table>
