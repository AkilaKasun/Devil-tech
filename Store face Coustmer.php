...
<html>
  ...
  body
  {
    background-image: url( "Images/530401.jpg");
...
<body>
	...
	<header><img scr="C:\Users\AKILA KASUN\OneDrive - Sri Lanka Institute of Information Technology\Desktop\BuyFresh.lk--master\Images\Untitled-1.png" alt=""></header>
		...
		<ul class="nav-links" >
			<li> <a href="AfterlogCoustmer.php" ><i class="fa-sharp fa-solid fa-house"></i>Home</a></li>
    ...
    <tbody>
      <tr>
	    <td><div class="pic"> <a href= "viweStoreCoustmer.php"><img src="Images/img1.jpg.jpg" width="235" height="225"></a>
         <p style="font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif; color: #FFF7F7;">MSI</p>
	    </div></td>
        <td><div class="pic"> <a href= "viweStoreasusCoustmer.php"><img src="Images/img2.jpg" width="235" height="225"></a>
         <p style="font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif; color: #FFFFFF;">ASUS</p>
	    </div></td>
      </tr>
      <tr>
        <td><div class="pic"> <a href= "viweStoreacerCoustmer.php"><img src="Images/img3.jpg" width="235" height="225"></a>
         <p style="font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif; color: #FFFFFF;"><span style="color: #FFFFFF">ace</span>r</p>
	    </div></td>
        <td><div class="pic"> <a href= "viweStoredellCoustmer.php"><img src="Images/img4.jpg" width="235" height="225"></a>
         <p style="font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif; color: #FFFFFF;" >DELL</p>
	    </div></td>
      </tr>
    </tbody>
  </table>
